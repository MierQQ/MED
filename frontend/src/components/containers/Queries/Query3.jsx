...
function Query3() {
    ...
    let [surgeriesNumber, setSurgeriesNumber] = useState(0);
    ...
    const getQuery = () => {
        axios.get('/query/3', {
            params: {
                ...
                surgeriesNumber: surgeriesNumber
            }
        }).then((response) => {
    ...
    return (
        <div>
            <div className="inputs-container">
                ...
                <div className="input-container">
                    <label className="input-label">surgeriesNumber</label>
                    <input onChange={(e) => {
                        setSurgeriesNumber(e.target.value)
                    }}/>
                </div>
                <div className="input-container">
